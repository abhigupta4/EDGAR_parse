...
for x in xrange(startyear, endyear + 1):    #Creating the list of years to be passed based on user input
...
basedir = '/home/shanil/Desktop/p/Hormel/full-index/'    #Setting up the base directory
...
for i in yearlist:
    ...
    for j in qtrlist:
        ...
        for l in xrange(0, 5):		#Set to 5 just for testing
            ...
            if not os.path.exists(basedir + i + '/' + j + '/TestNick' + str(l) + '.zip'):   #Checking if the company zip folder exists
        ...
        for n in xrange(0, 5):			#Set to 5 for testing
            ...
            with open(basedir + i + '/' + j + '/data' + str(FileCount)+'.csv', mode = 'ab') as f:
